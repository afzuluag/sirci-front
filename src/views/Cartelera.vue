    ...
    <div class="cartelera">
      ...
      <div class="cartelera-container">
        <CarteleraComp
          ...
          v-bind:clasif="cartelera.clasif"
          v-bind:puntuacion="cartelera.puntuacion"
          v-bind:horarios="cartelera.horarios"
          v-bind:reparto="cartelera.reparto"
          v-bind:sinopsis="cartelera.sinopsis"
        ></CarteleraComp>
      </div>
    </div>
    <Footer />
